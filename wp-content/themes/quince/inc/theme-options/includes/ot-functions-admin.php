          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Theme Options', 'quince' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', esc_html__( 'Theme Options', 'quince' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Theme Options updated.', 'quince' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Theme Options reset.', 'quince' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Save Changes', 'quince' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . esc_html__( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'quince' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => esc_html__( 'OptionTree', 'quince' ),
        'menu_title'      => esc_html__( 'OptionTree', 'quince' ),
      ...
      array(
        ...
        'page_title'      => esc_html__( 'Settings', 'quince' ),
        'menu_title'      => esc_html__( 'Settings', 'quince' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => esc_html__( 'Theme Options updated.', 'quince' ),
        'reset_message'   => esc_html__( 'Theme Options reset.', 'quince' ),
        'button_text'     => esc_html__( 'Save Settings', 'quince' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => esc_html__( 'Theme Options UI', 'quince' )
          ),
          array(
            'id'          => 'import',
            'title'       => esc_html__( 'Import', 'quince' )
          ),
          array(
            'id'          => 'export',
            'title'       => esc_html__( 'Export', 'quince' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => esc_html__( 'Layouts', 'quince' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => esc_html__( 'Theme Options UI Builder', 'quince' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => esc_html__( 'Settings XML', 'quince' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => esc_html__( 'Settings', 'quince' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => esc_html__( 'Theme Options', 'quince' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => esc_html__( 'Layouts', 'quince' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => esc_html__( 'Settings PHP File', 'quince' ),
          ...
          array(
            ...
            'label'       => esc_html__( 'Layout Management', 'quince' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => esc_html__( 'Documentation', 'quince' ),
        'menu_title'      => esc_html__( 'Documentation', 'quince' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => esc_html__( 'Creating Options', 'quince' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => esc_html__( 'Option Types', 'quince' )
          ),
          array(
            'id'          => 'functions',
            'title'       => esc_html__( 'Function References', 'quince' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => esc_html__( 'Theme Mode', 'quince' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => esc_html__( 'Meta Boxes', 'quince' )
          ),
          array(
            'id'          => 'examples',
            'title'       => esc_html__( 'Code Examples', 'quince' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => esc_html__( 'Layouts Overview', 'quince' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => esc_html__( 'Overview of available Theme Option fields.', 'quince' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => esc_html__( 'Option types in alphabetical order & hooks to filter them.', 'quince' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => esc_html__( 'Function Reference:ot_get_option()', 'quince' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => esc_html__( 'Function Reference:get_option_tree()', 'quince' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => esc_html__( 'Theme Mode', 'quince' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => esc_html__( 'Meta Boxes', 'quince' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => esc_html__( 'Code examples for front-end development.', 'quince' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => esc_html__( 'What\'s a layout anyhow?', 'quince' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'option-tree', 'invalid_border_width', sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'quince' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'option-tree', 'invalid_hex', sprintf( esc_html__( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'quince' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_dimension_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'quince' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_spacing_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'quince' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    wp_enqueue_script( 'ot-admin-js', OT_URL . 'assets/js/ot-admin.js', array( 'jquery', 'jquery-ui-tabs', 'jquery-ui-sortable', 'jquery-ui-slider', 'wp-color-picker', 'jquery-ui-datepicker' ), OT_VERSION );

    /* create localized JS array */
    $localized_array = array( 
      'ajax'                  => admin_url( 'admin-ajax.php' ),
      'nonce'                 => wp_create_nonce( 'option_tree' ),
      'upload_text'           => apply_filters( 'ot_upload_text', esc_html__( 'Send to OptionTree', 'quince' ) ),
      'remove_media_text'     => esc_html__( 'Remove Media', 'quince' ),
      'reset_agree'           => esc_html__( 'Are you sure you want to reset back to the defaults?', 'quince' ),
      'remove_no'             => esc_html__( 'You can\'t remove this! But you can edit the values.', 'quince' ),
      'remove_agree'          => esc_html__( 'Are you sure you want to remove this?', 'quince' ),
      'activate_layout_agree' => esc_html__( 'Are you sure you want to activate this layout?', 'quince' ),
      'setting_limit'         => esc_html__( 'Sorry, you can\'t have settings three levels deep.', 'quince' ),
      'delete'                => esc_html__( 'Delete Gallery', 'quince' ), 
      'edit'                  => esc_html__( 'Edit Gallery', 'quince' ), 
      'create'                => esc_html__( 'Create Gallery', 'quince' ), 
      'confirm'               => esc_html__( 'Are you sure you want to delete this Gallery?', 'quince' ),
      'date_current'          => esc_html__( 'Today', 'quince' ),
      'date_time_current'     => esc_html__( 'Now', 'quince' ),
      'date_close'            => esc_html__( 'Close', 'quince' ),
      'replace'               => esc_html__( 'Featured Image', 'quince' ),
      'with'                  => esc_html__( 'Image', 'quince' )
    );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'option-tree', array(
      'labels'              => array( 'name' => esc_html__( 'Option Tree', 'quince' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => esc_html__( 'General', 'quince' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => esc_html__( 'Sample Text Field Label', 'quince' ),
              'desc'      => esc_html__( 'Description for the sample text field.', 'quince' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings updated.', 'quince' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be saved.', 'quince' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings Imported.', 'quince' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be imported.', 'quince' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Data Imported.', 'quince' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Data could not be imported.', 'quince' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Imported.', 'quince' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be imported.', 'quince' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Updated.', 'quince' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be updated.', 'quince' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts have been deleted.', 'quince' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layout activated.', 'quince' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => esc_html__('Background', 'quince'),
      'border'                    => esc_html__('Border', 'quince'),
      'box-shadow'                => esc_html__('Box Shadow', 'quince'),
      'category-checkbox'         => esc_html__('Category Checkbox', 'quince'),
      'category-select'           => esc_html__('Category Select', 'quince'),
      'checkbox'                  => esc_html__('Checkbox', 'quince'),
      'colorpicker'               => esc_html__('Colorpicker', 'quince'),
      'colorpicker-opacity'       => esc_html__('Colorpicker Opacity', 'quince'),
      'css'                       => esc_html__('CSS', 'quince'),
      'custom-post-type-checkbox' => esc_html__('Custom Post Type Checkbox', 'quince'),
      'custom-post-type-select'   => esc_html__('Custom Post Type Select', 'quince'),
      'date-picker'               => esc_html__('Date Picker', 'quince'),
      'date-time-picker'          => esc_html__('Date Time Picker', 'quince'),
      'dimension'                 => esc_html__('Dimension', 'quince'),
      'gallery'                   => esc_html__('Gallery', 'quince'),
      'google-fonts'              => esc_html__('Google Fonts', 'quince'),
      'javascript'                => esc_html__('JavaScript', 'quince'),
      'link-color'                => esc_html__('Link Color', 'quince'),
      'list-item'                 => esc_html__('List Item', 'quince'),
      'measurement'               => esc_html__('Measurement', 'quince'),
      'numeric-slider'            => esc_html__('Numeric Slider', 'quince'),
      'on-off'                    => esc_html__('On/Off', 'quince'),
      'page-checkbox'             => esc_html__('Page Checkbox', 'quince'),
      'page-select'               => esc_html__('Page Select', 'quince'),
      'post-checkbox'             => esc_html__('Post Checkbox', 'quince'),
      'post-select'               => esc_html__('Post Select', 'quince'),
      'radio'                     => esc_html__('Radio', 'quince'),
      'radio-image'               => esc_html__('Radio Image', 'quince'),
      'select'                    => esc_html__('Select', 'quince'),
      'sidebar-select'            => esc_html__('Sidebar Select',  'quince'),
      'slider'                    => esc_html__('Slider', 'quince'),
      'social-links'              => esc_html__('Social Links', 'quince'),
      'spacing'                   => esc_html__('Spacing', 'quince'),
      'tab'                       => esc_html__('Tab', 'quince'),
      'tag-checkbox'              => esc_html__('Tag Checkbox', 'quince'),
      'tag-select'                => esc_html__('Tag Select', 'quince'),
      'taxonomy-checkbox'         => esc_html__('Taxonomy Checkbox', 'quince'),
      'taxonomy-select'           => esc_html__('Taxonomy Select', 'quince'),
      'text'                      => esc_html__('Text', 'quince'),
      'textarea'                  => esc_html__('Textarea', 'quince'),
      'textarea-simple'           => esc_html__('Textarea Simple', 'quince'),
      'textblock'                 => esc_html__('Textblock', 'quince'),
      'textblock-titled'          => esc_html__('Textblock Titled', 'quince'),
      'typography'                => esc_html__('Typography', 'quince'),
      'upload'                    => esc_html__('Upload', 'quince')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      array(
        'value'   => 'left-sidebar',
        'label'   => esc_html__( 'Left Sidebar', 'quince' ),
        'src'     => OT_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => esc_html__( 'Right Sidebar', 'quince' ),
        'src'     => OT_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => esc_html__( 'Full Width (no sidebar)', 'quince' ),
...
if ( ! function_exists( 'ot_list_item_settings' ) ) {
  ...
  function ot_list_item_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_list_item_settings', array(
      ...
      array(
        'id'        => 'description',
        'label'     => esc_html__( 'Description', 'quince' ),
        'desc'      => '',
        'std'       => '',
...
if ( ! function_exists( 'ot_social_links_settings' ) ) {
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        'id'        => 'name',
        'label'     => esc_html__( 'Name', 'quince' ),
        'desc'      => esc_html__( 'Enter the name of the social website.', 'quince' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => esc_html__( 'Enter the text shown in the title attribute of the link.', 'quince' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( esc_html__( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'quince' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'option-tree', 'dynamic_css', sprintf( esc_html__( 'Unable to write to file %s.', 'quince' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . esc_html__( 'edit', 'quince' ) . '">
          <span class="icon ot-icon-pencil"></span>' . esc_html__( 'Edit', 'quince' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'quince' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'quince' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( 'Section Title: Displayed as a menu item on the Theme Options page.', 'quince' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( 'Section ID: A unique lower case alphanumeric string, underscores allowed.', 'quince' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Label: Displayed as the label of a form element on the Theme Options page.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'ID: A unique lower case alphanumeric string, underscores allowed.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( 'Type: Choose one of the available option types from the dropdown.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . esc_html__( 'Description: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( 'Choices: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'quince' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Choice', 'quince' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( 'Settings: This will only affect the List Item option type.', 'quince' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Setting', 'quince' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Standard: Setting the standard value for your option only works for some option types. Read the OptionTree->Documentation for more information on which ones.', 'quince' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Rows: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Post Type: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Taxonomy: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Min, Max, & Step: Add a comma separated list of options in the following format 0,100,1 (slide from 0-100 in intervals of 1). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'CSS Class: Add and optional class to this option type.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . sprintf( esc_html__( 'Condition: Add a comma separated list (no spaces) of conditions in which the field will be visible, leave this setting empty to always show the field. In these examples, value is a placeholder for your condition, which can be in the form of %s.', 'quince' ), '<code>field_id:is(value)</code>, <code>field_id:not(value)</code>, <code>field_id:contains(value)</code>, <code>field_id:less_than(value)</code>, <code>field_id:less_than_or_equal_to(value)</code>, <code>field_id:greater_than(value)</code>, or <code>field_id:greater_than_or_equal_to(value)</code>' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( 'Operator: Choose the logical operator to compute the result of the conditions.', 'quince' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . esc_html__( 'and', 'quince' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . esc_html__( 'or', 'quince' ) . '</option>
              </select>
            </div>
          </div>
        </div>
  ...
  function ot_choices_view( $name, $key, $choice = array() ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Image Source (Radio Image only)', 'quince' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . esc_html__( 'Title: Displayed as a contextual help menu item on the Theme Options page.', 'quince' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . esc_html__( 'Content: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'quince' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : esc_html__( 'Layout', 'quince' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . esc_html__( 'Activate', 'quince' ) . '">
          <span class="icon ot-icon-square-o"></span>' . esc_html__( 'Activate', 'quince' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. esc_html__( 'Delete', 'quince' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'quince' ) . '
        </a>
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . esc_html__( 'New Layout', 'quince' ) . '">' . esc_html__( 'New Layout', 'quince' ) . '</button>';
...
function ot_meta_box_post_format_gallery( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_gallery', array(
    ...
    'title'     => esc_html__( 'Gallery', 'quince' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
  ...
  return apply_filters( 'ot_meta_box_post_format_link', array(
    ...
    'fields'    => array(
      array(
        'id'      => '_format_link_url',
        'label'   => '',
        'desc'    => esc_html__( 'Link URL', 'quince' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Link Title', 'quince' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Name (ex. author, singer, actor)', 'quince' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source URL', 'quince' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Title (ex. book, song, movie)', 'quince' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Date', 'quince' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'quince' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'quince' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'quince' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'quince' ) .'</a>', '<code>[audio]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
