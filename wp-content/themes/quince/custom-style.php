...
function mnky_custom_css() {
	...
	$custom_css .= '
		.themecolor_bg, .wpb_button.wpb_btn_themecolor, .wpb_button.wpb_btn_themecolor:hover, input[type=\'submit\'], th, #wp-calendar #today, .vc_progress_bar .vc_single_bar.bar_themecolor .vc_bar, #site-navigation .header_cart_button .cart_product_count, .woocommerce a.added_to_cart,.woocommerce-page a.added_to_cart, .header-search .search-input, .pricing-box .plan-badge {background-color:'. ot_get_option('accent_color', '#8fc941') .';}
	';
	
	$custom_css .= '::selection{background-color:'. ot_get_option('accent_color', '#8fc941') .';}::-moz-selection{background-color:'. ot_get_option('accent_color', '#8fc941') .';}';

	
	// Accent color (color)
	$custom_css .= '
		dt,.wpb_button.wpb_btn_themecolor.wpb_btn-minimal, .themecolor_txt, #site-header #site-navigation ul li a:hover, #site-header #site-navigation .search_button:hover, #site-header #site-navigation .header_cart_button:hover, #site-header #site-navigation ul li.megamenu ul li a:hover, #site-header #site-navigation ul li.current-menu-item > a,.single-post #site-header #site-navigation ul li.current_page_parent > a, #site-header #site-navigation ul li.current-menu-ancestor > a, a:hover, #site-header #site-navigation ul li.megamenu ul li.current-menu-item > a,.single-post #site-header #site-navigation ul li.megamenu ul li.current_page_parent > a,#site-header #site-navigation ul li.megamenu ul li.current-menu-ancestor > a, .widget a, span.required, #comments .comment-reply-link:hover,#comments .comment-meta a:hover, .vc_toggle_default .vc_toggle_title .vc_toggle_icon:after, .post-entry-header .entry-meta a:hover, .tag-links:before, #comments p.comment-notes:before, p.logged-in-as:before, p.must-log-in:before, .entry-meta-footer .meta-date:before, article.sticky .post-preview:after, .separator_w_icon i, blockquote:after, article.format-quote .quoute-text:after, article.format-link .link-text:after, article.format-status .status-text:after, article.format-chat p:nth-child(odd):before, .entry-meta-footer a:hover, .footer-sidebar a:hover, .team_member_position, .woocommerce-MyAccount-navigation ul li.is-active a{color:'. ot_get_option('accent_color', '#8fc941') .';}		
	';


	// Accent color (border-color)
	$custom_css .= '
		.wpb_button.wpb_btn_themecolor, .wpb_button.wpb_btn_themecolor:hover, input[type=\'submit\'], th, #comments .comment-reply-link:hover, #site-navigation, #site-navigation ul li ul, .woocommerce-MyAccount-navigation ul li.is-active {border-color:'. ot_get_option('accent_color', '#8fc941') .';}
	';
	
	
	// Accent color (misc)
	$custom_css .= '
		.widget-area .widget .tagcloud a:hover, .post-navigation a:hover {background-color:'. ot_get_option('accent_color', '#8fc941') .';}
		article.format-image .post-preview a:after{background-color:'. ot_get_option('accent_color', '#8fc941') .'; background-color:rgba('. mnky_hex2rgb(ot_get_option('accent_color', '#8fc941')) .', 0.75);}
		article.format-image .post-preview a:hover:after, article.format-image .post-preview a.touch-hover:after {background-color:'. ot_get_option('accent_color', '#8fc941') .'; background-color:rgba('. mnky_hex2rgb(ot_get_option('accent_color', '#8fc941')) .', 1);}
	';
	...
	if (class_exists( 'WooCommerce' )){
		$custom_css .= '
			.woocommerce div.product span.price,.woocommerce div.product p.price,.woocommerce #content div.product span.price,.woocommerce #content div.product p.price,.woocommerce-page div.product span.price,.woocommerce-page div.product p.price,.woocommerce-page #content div.product span.price,.woocommerce-page #content div.product p.price, .woocommerce ul.products li.product .price,.woocommerce-page ul.products li.product .price, #site-header #site-navigation .header_cart_widget .woocommerce ul li a:hover, #site-navigation .header_cart_widget .woocommerce .buttons a:hover, .woocommerce ul li.product-category:hover h3,.woocommerce ul li.product-category:hover h3 mark {color:'. ot_get_option('accent_color', '#8fc941') .';}		
		';
		
		$custom_css .= '
			.woocommerce a.button,.woocommerce button.button,.woocommerce input.button,.woocommerce #respond input#submit,.woocommerce #content input.button,.woocommerce-page a.button,.woocommerce-page button.button,.woocommerce-page input.button,.woocommerce-page #respond input#submit,.woocommerce-page #content input.button, .woocommerce a.button.alt,.woocommerce button.button.alt,.woocommerce input.button.alt,.woocommerce #respond input#submit.alt,.woocommerce #content input.button.alt,.woocommerce-page a.button.alt,.woocommerce-page button.button.alt,.woocommerce-page input.button.alt,.woocommerce-page #respond input#submit.alt,.woocommerce-page #content input.button.alt, .woocommerce .widget_price_filter .ui-slider .ui-slider-handle,.woocommerce-page .widget_price_filter .ui-slider .ui-slider-handle {background-color:'. ot_get_option('accent_color', '#8fc941') .';}		
		';
				
		$custom_css .= '
			.woocommerce nav.woocommerce-pagination ul li span.current,.woocommerce nav.woocommerce-pagination ul li a:hover,.woocommerce nav.woocommerce-pagination ul li a:focus,.woocommerce #content nav.woocommerce-pagination ul li span.current,.woocommerce #content nav.woocommerce-pagination ul li a:hover,.woocommerce #content nav.woocommerce-pagination ul li a:focus,.woocommerce-page nav.woocommerce-pagination ul li span.current,.woocommerce-page nav.woocommerce-pagination ul li a:hover,.woocommerce-page nav.woocommerce-pagination ul li a:focus,.woocommerce-page #content nav.woocommerce-pagination ul li span.current,.woocommerce-page #content nav.woocommerce-pagination ul li a:hover,.woocommerce-page #content nav.woocommerce-pagination ul li a:focus {background-color:'. ot_get_option('accent_color', '#8fc941') .';}		
		';
	}
	...
	$body_font_styles = array(
		( ! empty( $body_font['font-family'] ) ) ? 'font-family:'. str_replace("+", " ", $body_font['font-family']) : 'font-family:Ubuntu',
		...
		'font-size:'. ot_get_option('body_size', '13px')		
	);
	
	$body_font_style = implode('; ', array_filter($body_font_styles));	
	$custom_css .= 'body{'.$body_font_style.'}';

	$custom_css .= ( ! empty( $body_font['font-family'] ) ) ? 'select, input, textarea, .wpb_button{font-family:'. str_replace("+", " ", $body_font['font-family']) .'}' : 'select, input, textarea, .wpb_button{font-family:Ubuntu}';
		
	// Menu typo
	$menu_font = ot_get_option('menu_font');
	
	$menu_font_styles = array(
		( ! empty( $menu_font['font-family'] ) ) ? 'font-family:'. str_replace("+", " ", $menu_font['font-family']) : 'font-family:Ubuntu',
	...
	$heading_font_styles = array(
		( ! empty( $heading_font['font-family'] ) ) ? 'font-family:'. str_replace("+", " ", $heading_font['font-family']) : 'font-family:Ubuntu',
	...
	$vc_heading_font_styles = array(
		( ! empty( $vc_heading_font['font-family'] ) ) ? 'font-family:'. str_replace("+", " ", $vc_heading_font['font-family']) : 'font-family:Ubuntu',
	...
	$widget_font_styles = array(
		( ! empty( $widget_font['font-family'] ) ) ? 'font-family:'. str_replace("+", " ", $widget_font['font-family']) : 'font-family:Ubuntu',
	...
	(ot_get_option('overlay_header_background') != '') ? $custom_css .= '#site-header.overlay-header #header-wrapper{background-color:'. ot_get_option('overlay_header_background') .'; background-color:rgba('. mnky_hex2rgb(ot_get_option('overlay_header_background')) .', '.ot_get_option('overlay_header_background_opacity', '50') / 100 .');}' : $custom_css .= '#site-header.overlay-header #header-wrapper{background-color:transparent;}';
	
	(ot_get_option('overlay_header_background_sticked') != '') ? $custom_css .= '#site-header.overlay-header.header-sticked #header-wrapper{background-color:'. ot_get_option('overlay_header_background_sticked') .';}' : '';
	
	(ot_get_option('overlay_header_background_sticked') != '') ? $custom_css .= '@media only screen and (max-width: 979px) {#site-header.overlay-header #header-wrapper {background-color:'. ot_get_option('overlay_header_background_sticked') .';}}' : '';
	$custom_css .= '@media only screen and (max-width: 979px) {#site-header.overlay-header{position:relative;}}';
	...
	(ot_get_option('submenu_hover_bg') != '') ? $custom_css .= '#site-header #site-navigation ul li un li:hover > a {background-color:'. ot_get_option('submenu_hover_bg'). '}' : '';
	...
	(ot_get_option('headings_color') != '') ? $custom_css .= 'h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .woocommerce-page.woocommerce-cart .cart-empty, #site-navigation .header_cart_widget .woocommerce .buttons a, #site-navigation .header_cart_widget .woocommerce .total {color:'. ot_get_option('headings_color') .'}' : '';
	...
	// Title style
	(ot_get_option('title_border') != '') ? $custom_css .= '.page-header .page-title{ border-bottom-color: '. ot_get_option('title_border') .';}' : '';
	(ot_get_option('title_border') != '') ? $custom_css .= '@media only screen and (max-width: 979px){ 
	.breadcrumbs-trail{ border-bottom-color: '. ot_get_option('title_border') .';}}' : '';
